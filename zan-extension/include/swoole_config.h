...
#define SW_MAX_FILE_CONTENT        (64*1024*1024) //for file_get_contents
#define SW_MAX_LISTEN_PORT         128
...
#define SW_TASK_TMP_FILE                 "/tmp/zan.task.XXXXXX"
...
#define SW_WEBSOCKET_SERVER_SOFTWARE     "zan-websocket-server"
