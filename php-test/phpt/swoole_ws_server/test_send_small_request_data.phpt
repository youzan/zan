...
require_once __DIR__."/../../apitest/swoole_websocket_server/send_small_request_data.php";

$swoole_websocket_server = __DIR__ . "/../../apitest/swoole_websocket_server/swoole_websocket_server.php";
